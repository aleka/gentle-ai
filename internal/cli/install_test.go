...
func TestNormalizeInstallFlagsDefaults(t *testing.T) {
	...
	want := model.Selection{
		Agents:  []model.AgentID{model.AgentClaudeCode, model.AgentOpenCode, model.AgentGeminiCLI, model.AgentCodex, model.AgentCursor, model.AgentVSCodeCopilot, model.AgentAntigravity, model.AgentWindsurf, model.AgentKimi},
...
func makeDetectionWithAgents(present ...string) system.DetectionResult {
	...
	known := []string{"claude-code", "opencode", "gemini-cli", "cursor", "vscode-copilot", "codex", "antigravity", "windsurf", "kimi"}
